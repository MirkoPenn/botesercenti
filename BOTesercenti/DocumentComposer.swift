...
class DocumentComposer: NSObject {
    ...
    func renderHTML1() -> String! {
        do {
            ...
            htmlContent = htmlContent.replacingOccurrences(of: "#RISOSREESTERNE28#", with: "")
            ...
            htmlContent = htmlContent.replacingOccurrences(of: "#NEGSTIVO61#", with: "")
    ...
    func renderHTML2() -> String! {
        do {
            ...
            htmlContent = htmlContent.replacingOccurrences(of: "#ELEMENTI3#", with: "")
            ...
            htmlContent = htmlContent.replacingOccurrences(of: "#ELEMENTI33#", with: "")
            ...
            htmlContent = htmlContent.replacingOccurrences(of: "#PRODMAT38#", with: "10.000 €")
